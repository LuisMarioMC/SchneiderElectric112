<?php
 require_once ('controlador_modificar_meta_sell_in.php');
?>
...
<html lang="es">
 <head>
  <?php
   ...
   echo ' <title>Modificar Meta Sell In</title>'; 
	   ...
	   <div class="panel-body">
        ...
        <div class="row">         
         ...
         <div class="col-lg-12">		 
		  ...
		  <form class="form-horizontal" role="form" name="formulario" action="modificar_meta_sell_in.php?id=<?php echo $id_modificar ?>" autocomplete="off" method="post" enctype="multipart/form-data">  

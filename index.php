      ...
      <div class="panel-body">
       <form action="index.php" method="post">
        <fieldset>
         ...
         <div class="form-group">
          <input class="form-control" placeholder="Contrase&ntilde;a" name="contrasenia" title="Introduce tu contrase&ntilde;a." type="password" value="" required/>
         </div>
		 <?php
		  if($error1 == 1)
		  {
           ...
           echo' El Usuario o la contrase&ntilde;a que has introducido no son correctas.';
           echo'</div>';
		  }
		  if($error2 == 1)
		  {
		   echo'<div class="alert alert-danger alert-dismissable">';
           echo' <button type="button" class="close" data-dismiss="alert">&times;</button>';
           echo' El Usuario se encuentra inhabilitado.';
           echo'</div>';
		  }
		 ?>
         
		 <input class="btn btn-lg btn-success btn-block" name="" type="submit" value="Ingresar">

		 <div class="forgot-pass">
          <a href="recuperar_contrasenia.php" class="green-txt" >He olvidado mi contrase&ntilde;a</a>
         </div>
        </fieldset>
       </form>
      </div>

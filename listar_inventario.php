<?php
 require_once ('controlador_listar_inventario.php');
?>
...
<html lang="es">
 ...
 <?php
  ...
  echo ' <title>Listar Inventario</title>'; 
  require_once ('librerias_css.php');
  require_once ('funciones_javascript_inventario.php');
 ?>
      ...
      <div class="panel panel-default">
       ...
       <div class="panel-body">
		...
		<ul class="nav nav-tabs">
		 <?php
		  echo'<li class="active"><a href="listar_inventario.php?id='.$id_evento.'">Listar</a></li>';
		  echo'<li><a href="crear_inventario.php?id='.$id_evento.'">Crear</a></li>';	      
		 ?>
	    </ul>
	    <br>
	   
        <div class="table-responsive">
         <table class="table table-striped table-bordered table-hover" id="inventario">
          <thead>
           <tr>

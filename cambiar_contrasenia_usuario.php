<?php
 require_once ('controlador_cambiar_contrasenia_usuario.php');
?>
...
<html lang="es">
 <head>
  <?php
   ...
   echo ' <title>Cambiar Contrase&ntilde;a Usuario</title>'; 
   require_once ('librerias_css.php');
   require_once ('funciones_javascript_cambiar_contrasenia_usuario.php');
  ?>
 </head>
     ...
     <div class="col-lg-12">
      <div class="panel panel-default">
       <div class="panel-heading">
        Cambiar Contrase&ntilde;a Usuario
       </div>
	   ...
	   <div class="panel-body">
        ...
        <div class="row">
         <div class="col-lg-12">		 
		  ...
		  <form class="form-horizontal" onsubmit="return checkform($('#pswd').val());" role="form" name="formulario" action="cambiar_contrasenia_usuario.php?id=<?php echo $id_usuario ?>" autocomplete="off" method="post" enctype="multipart/form-data">

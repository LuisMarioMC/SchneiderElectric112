<?php
 require_once ('controlador_listar_mes.php');
?>
...
<html lang="es">
 ...
 <?php
  ...
  echo ' <title>Listar Meses</title>'; 
  require_once ('librerias_css.php');
  require_once ('funciones_javascript_mes.php');
 ?>
      ...
      <div class="panel panel-default">
       ...
       <div class="panel-body">
        ...
        <div class="table-responsive">
         <table class="table table-striped table-bordered table-hover" id="mes">
          <thead>
           <tr>
		    <th></th>
		    <th>Nombre</th>

...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		/**
		 * Activar desplazamiento horizontal. Cuando una tabla es demasiado grande para caber en un determinado diseño, o si tiene un gran número de columnas de la tabla, puede habilitar x-desplazamiento para mostrar la tabla en una ventana, que se puede desplazar. Esta propiedad puede ser `true` que permitirá la tabla para desplazarse horizontalmente cuando sea necesario, o cualquier unidad de CSS, o un número (en cuyo caso será tratado como una medición de pixel). Establecer como simplemente se recomienda `true`.

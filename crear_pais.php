<?php
 require_once ('controlador_crear_pais.php');
?>
...
<html lang="es">
 <head>
  <?php
   ...
   echo ' <title>Crear Pa&iacute;s</title>';
	   ...
	   <div class="panel-body">
	    ...
	    <ul class="nav nav-tabs">
		 <?php
		  ...
		  echo'<li class="active"><a href="crear_pais.php">Crear</a></li>';
		 ?>
	    </ul>
	    <br>
        ...
        <div class="row">         
         ...
         <div class="col-lg-12">		 
		  ...
		  <form class="form-horizontal" role="form" name="formulario" action="crear_pais.php" autocomplete="off" method="post" enctype="multipart/form-data">  

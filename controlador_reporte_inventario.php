<?php
 ...
 if($_POST)
 {
  ...
  {
   $error_reporte_inventario = '<br><div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button><strong>Error: </strong>Subir Reporte Inventario.</div>';
   $error = 1;
  }
  if($id_mes == 0)
  {
  ...
  require_once ('modelo_reporte_inventario.php');
  ...
  echo '<script language="JavaScript" type="text/javascript">document.location.href="reporte_inventario.php?m='.$mensaje.'"</script>';
 }
 else
 {
  $error = 1;
 ...
 if($i != 1)
 {
  ...
  {  
   ...
   {
    $listar .= '  <a href="controlador_estado_reporte.php?id='.$reportes['id'].'" style="text-decoration: none">';
   ...
   */
   ...
   $listar .= '   <a href="listar_detalle_inventario.php?id='.$reportes[id].'" style="text-decoration: none"><i class="fa fa-arrow-right fa-fw"></i></a>&nbsp;';
 ...
 $mensaje = 0;
 require_once ('mensajes_reporte_inventario.php'); 

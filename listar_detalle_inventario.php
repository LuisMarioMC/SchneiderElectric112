<?php
 require_once ('controlador_listar_detalle_inventario.php');
?>
...
<html lang="es">
 ...
 <?php
  ...
  echo ' <title>Listar Detalle Inventario</title>'; 
     ...
     <div class="col-lg-12">
      <div class="panel panel-default">
       <div class="panel-heading">
        Listar Detalle Inventario
       </div>
	   
       <div class="panel-body">
	   	   
        <div class="table-responsive">
         <table class="table table-striped table-bordered table-hover" id="detalle_inventario">
          <thead>
           <tr>
		    <th></th>
		    <th>Producto</th>

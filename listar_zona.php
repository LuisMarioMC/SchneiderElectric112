<?php
 require_once ('controlador_listar_zona.php');
?>
      ...
      <div class="panel panel-default">
       ...
       <div class="panel-body">
		...
		<ul class="nav nav-tabs">
 		 <?php
		  echo'<li class="active"><a href="listar_zona.php">Listar</a></li>';
        ...
        <div class="table-responsive">
         <table class="table table-striped table-bordered table-hover" id="zona">
          <thead>
           <tr>
		    <th></th>
		    <th>Nombre</th>

<?php
 require_once ('controlador_reporte_ventas.php');
?>
...
<html lang="es">
 ...
 <?php
  ...
  echo ' <title>Reporte Ventas</title>'; 
  require_once ('librerias_css.php');
  require_once ('funciones_javascript_reporte_ventas.php');
 ?>
      ...
      <div class="panel panel-default">
       ...
       <div class="panel-body">
	    ...
	    <?php
		 ...
		 echo '  <form class="form-horizontal" role="form" name="formulario" action="reporte_ventas.php" autocomplete="off" method="post" enctype="multipart/form-data">';

<?php
 require_once ('controlador_reporte_compras.php');
?>
...
<html lang="es">
 ...
 <?php
  ...
  echo ' <title>Reporte Compras</title>'; 
  require_once ('librerias_css.php');
  require_once ('funciones_javascript_reporte_compras.php');
 ?>
      ...
      <div class="panel panel-default">
       ...
       <div class="panel-body">
	    ...
	    <?php
		 ...
		 echo '  <form class="form-horizontal" role="form" name="formulario" action="reporte_compras.php" autocomplete="off" method="post" enctype="multipart/form-data">';
	
		 echo '   <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">';
 		 echo '	   <div class="form-group">';
		 echo '	    <label>Reporte de Compras</label>';
         echo '     <input class="file" id="reporte_compras" name="reporte_compras" type="file" data-show-upload="false" data-show-caption="true" placeholder="Reporte Compras" required/>';
		 echo '	   </div>';
		 echo '   </div>';

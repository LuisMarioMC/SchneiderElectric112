<?php
 require_once ('controlador_crear_meta_sell_out.php');
?>
...
<html lang="es">
 <head>
  <?php
   ...
   echo ' <title>Crear Meta Sell Out</title>'; 
	   ...
	   <div class="panel-body">
	    ...
	    <ul class="nav nav-tabs">
		 <?php
		  ...
		  echo'<li class="active"><a href="crear_meta_sell_out.php">Crear</a></li>';
		 ?>
	    </ul>
	    <br>
        ...
        <div class="row">         
         ...
         <div class="col-lg-12">		 
		  ...
		  <form class="form-horizontal" role="form" name="formulario" action="crear_meta_sell_out.php" autocomplete="off" method="post" enctype="multipart/form-data">  

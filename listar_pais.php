<?php
 require_once ('controlador_listar_pais.php');
?>
...
<html lang="es">
 ...
 <?php
  ...
  echo ' <title>Listar Pa&iacute;s</title>'; 
      ...
      <div class="panel panel-default">
       ...
       <div class="panel-body">
		...
		<ul class="nav nav-tabs">
 		 <?php
		  echo'<li class="active"><a href="listar_pais.php">Listar</a></li>';
        ...
        <div class="table-responsive">
         <table class="table table-striped table-bordered table-hover" id="pais">
          <thead>
           <tr>
		    <th></th>
		    <th>Nombre</th>

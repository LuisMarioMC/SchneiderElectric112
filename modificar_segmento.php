<?php
 require_once ('controlador_modificar_segmento.php');
?>
...
<html lang="es">
 <head>
  <?php
   ...
   echo ' <title>Modificar Segmento</title>'; 
	   ...
	   <div class="panel-body">
	    ...
	    <ul class="nav nav-tabs">
		 <?php
		  ...
		  echo'<li><a href="crear_segmento.php">Crear</a></li>';	      
		 ?>
		</ul>
	    <br>
        ...
        <div class="row">         
         ...
         <div class="col-lg-12">		 
		  ...
		  <form class="form-horizontal" role="form" name="formulario" action="modificar_segmento.php?id=<?php echo $id_modificar ?>" autocomplete="off" method="post" enctype="multipart/form-data">  

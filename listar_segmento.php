<?php
 require_once ('controlador_listar_segmento.php');
?>
...
<html lang="es">
 ...
 <?php
  ...
  echo ' <title>Listar Segmento</title>'; 
      ...
      <div class="panel panel-default">
       ...
       <div class="panel-body">
		...
		<ul class="nav nav-tabs">
 		 <?php
		  echo'<li class="active"><a href="listar_segmento.php">Listar</a></li>';
        ...
        <div class="table-responsive">
         <table class="table table-striped table-bordered table-hover" id="segmento">
          <thead>
           <tr>
		    <th></th>
		    <th>Nombre</th>

<?php
 require_once ('controlador_crear_ciudad.php');
?>
	   ...
	   <div class="panel-body">
	    ...
	    <ul class="nav nav-tabs">
		 <?php
		  ...
		  echo'<li class="active"><a href="crear_ciudad.php">Crear</a></li>';
		 ?>
	    </ul>
	    <br>
        ...
        <div class="row">         
         ...
         <div class="col-lg-12">		 
		  ...
		  <form class="form-horizontal" role="form" name="formulario" action="crear_ciudad.php" autocomplete="off" method="post" enctype="multipart/form-data">  

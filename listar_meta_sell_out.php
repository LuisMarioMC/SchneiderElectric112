<?php
 require_once ('controlador_listar_meta_sell_out.php');
?>
...
<html lang="es">
 ...
 <?php
  ...
  echo ' <title>Listar Meta Sell Out</title>'; 
      ...
      <div class="panel panel-default">
       ...
       <div class="panel-body">
		...
		<ul class="nav nav-tabs">
 		 <?php
		  echo'<li class="active"><a href="listar_meta_sell_out.php">Listar</a></li>';
        ...
        <div class="table-responsive">
         <table class="table table-striped table-bordered table-hover" id="meta_sell_out">
          <thead>
           <tr>
		    <th>Distribuidor</th>
		    <th>A&ntilde;o</th>
